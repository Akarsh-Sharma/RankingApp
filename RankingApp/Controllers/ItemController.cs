...
namespace RankingApp.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        [HttpGet("{itemType:int}")] // this get api method takes in a parameter of type int
        public ItemModel[] Get(int itemType)
        {
            // queries our list and returns a list of items based on itemType passed in to our get call
